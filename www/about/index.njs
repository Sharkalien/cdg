...
this.value += html`
	<div class="box">
		...
		<div style="display: flex;">
			<img src="/img/about_leo.png" style="margin-right: 1em;">
			<div style="flex-grow: 1;">Leo, the golden boy. Born and raised in the prairie fields of Oklahoma.</div>
		</div>
		<h2 id="Cole">COLE</h2>
		<div style="display: flex;">
			<img src="/img/about_cole.png" style="margin-right: 1em;">
		...
		<div style="display: flex;">
			<img src="/img/about_chase.png" style="margin-right: 1em;">
		...
		<div style="display: flex;">
			<img src="/img/about_spicer.png" style="margin-right: 1em;">
